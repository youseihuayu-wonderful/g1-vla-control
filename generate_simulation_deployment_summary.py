...
def build() -> str:
    ...
    @media(max-width:1100px){.workspace{grid-template-columns:190px minmax(0,1fr);gap:16px}.metric-grid{grid-template-columns:repeat(3,1fr)}.decision-grid{grid-template-columns:1fr}.flow{grid-template-columns:repeat(4,1fr)}.hardware-phases{grid-template-columns:repeat(3,1fr)}.update-grid{grid-template-columns:repeat(2,1fr)}}
